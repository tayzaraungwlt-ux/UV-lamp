      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("η = 0.3 (Efficiency)"),
            const Text("Sf = 0.8 (Safety Factor)"),
            ...
            const Text("1. Measure furthest distance"),
            const Text("2. Avoid shadows"),
            const Text("3. Humidity < 60%"),
            const Text("4. No humans inside"),
            const Text("5. Warm-up 3–5 min"),
          ],
        ),
      ),
    );
